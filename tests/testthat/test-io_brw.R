...
test_that("brwtimeCheck validates input parameters", {
  ...
  expect_error(
    brwtimeCheck(mock_h5, start = -1, duration = 5),
    class = "error"
  )
})

test_that("brwtimeCheck calculates frame conversion correctly", {
...
test_that("brwselectChunk handles edge cases", {
